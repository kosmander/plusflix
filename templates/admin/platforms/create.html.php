...
<form method="POST" action="<?= $router->generatePath('admin-platforms-create') ?>" class="admin-form">
    ...
    <div class="form-group">
        ...
        <input type="url" id="logo_url" name="form[logo_url]" required
               value="<?= htmlspecialchars($_POST['form']['logo_url'] ?? '') ?>"
    ...
    <div class="form-group">
        ...
        <input type="url" id="platform_url" name="form[platform_url]" required
               value="<?= htmlspecialchars($_POST['form']['platform_url'] ?? '') ?>"
